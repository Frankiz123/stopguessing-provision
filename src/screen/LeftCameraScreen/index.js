...
class LeftCameraScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            box: null,
        ...
        return (
            <View style={{flex: 1, backgroundColor: '#DFE6EC'}}>     
                ...
                <View style={{height: 100, justifyContent: 'flex-end'}}>
                    <Text style={{alignSelf: 'center', marginBottom: 20, fontSize: 20, fontWeight: 'bold'}}>Turn to the Left</Text>
                </View>          
                <View style={{flex: 1}}>                    
                    ...
                    <Image 
                      source={require('src/image/camera/left.jpeg')}                             
                ...
                <View style={{height: 150, backgroundColor: '#DFE6EC'}}>                    
                    <View style={{                            
                        ...
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('rightCamera')}
        ...
        if (this.camera) {
            ...
            .then(res => {
                if (res.data.status == 1) {
                    ...
                    AsyncStorage.setItem('leftImage', res.data.filename);                    
...
export default LeftCameraScreen;
