...
class ToggleBox extends React.Component {
  ...
  render() {
    ...
    console.log("-----",this.state.animation, this.state.openTest )
    const icon = this.icons[this.state.expanded ? 'up' : 'down']

    return (
      <Animated.View style={[styles.box, this.props.style, this.state.openTest==true? {height : 400} :  {height: this.state.animation}]}>
