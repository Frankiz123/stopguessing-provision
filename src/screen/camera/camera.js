...
class CarmeraScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            box: null,
        ...
        return (
            ...
            />
                <View style={{height: 100, justifyContent: 'flex-end'}}>
                    <Text style={{alignSelf: 'center', marginBottom: 20, fontSize: 20, fontWeight: 'bold'}}>Full Face</Text>
                </View>          
                <View style={{flex: 1}}>                    
                    ...
                    <Image 
                      source={require('src/image/camera/front.jpeg')}                             
    ...
    takePicture = async () => {
        ...
        if (this.camera) {
            ...
            console.log ("name...", dataUri.substring(position + 1, dataUri.length))          
            ...
            .then(res => {
                if (res.data.status == 1) {
                    ...
                    AsyncStorage.setItem('frontImage', res.data.filename);
                    AsyncStorage.setItem('thankYouImage', dataUri);
                    this.props.navigation.navigate('rightCamera');
                }
            })  
