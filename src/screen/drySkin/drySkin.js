...
export default class drySkin extends Component {
    constructor(props) {
        super(props);
        this.state = {
            spinner: false,
    ...
    check = async (success, path) => {
        AsyncStorage.setItem("pathcountDry", JSON.stringify(this.state.pathcountDry));
        if (this.state.pathcountDry === 0 && Platform.OS !== 'ios') {
            this.props.navigation.navigate("oilySkin")
        } else {
    ...
    grabPixels = async (success, path) => {
        ...
        AsyncStorage.setItem("pathsForDrySkin", JSON.stringify(this.state.data));
        ...
        fetch('http://18.222.228.44:3000/drySkin', dataFetch)
                ...
                <View style={{}}>
                    ...
                    <RNSketchCanvas
                        ...
                        savePreference={() => {
                            return {
                                folder: 'StopGuessing',
                                filename: String("DrySkin-" + this.state.user_id + "-" + Math.ceil(Math.random() * 100000000)),
                                transparent: true,
                                imageType: 'jpg',
                                includeImage: true,
                                includeText: false,
